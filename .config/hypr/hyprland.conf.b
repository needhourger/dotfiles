...
# cursor
exec-once = hyprctl setcursor "Colloid-dark Cursors" 36
...
animations {
	...
	# bezier = wBezier, 0.05, 0.9, 0.1, 1.05
...
windowrulev2 = float, class:code, title:打开文件夹
windowrulev2 = float, class:code, title:打开文件
...
bind = $mainMod, A, exec, $luncher
bind = $mainMod, B, exec, $browser
bind = $mainMod, R, exec, $menu
bind = $altMod, L, exec, $scripts/lockscreen
...
# Screenshot a region
bind = $shiftMod, PRINT, exec, $scripts/hyprshot -m region
